...
class ArtWorkTableViewCell: UITableViewCell {
    ...
    var currentArtWorkViewModel: AnyObject?
    ...
    func bindData(artWorkViewModel: AnyObject) {
        ...
        case .tattoo:
            ...
            Manager.shared.loadImage(with: Request(url: URL(string: imageURLString)!)) {
                ...
                if (self.currentArtWorkViewModel as! TattooViewModel).cellHeight == 0 || (self.currentArtWorkViewModel as! TattooViewModel).cellHeight != (imageHeight + 48) {
